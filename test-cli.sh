#!/usr/bin/env bash
# =============================================================================
# YOSO Agent CLI Test Script
#
# Exercises all non-destructive CLI commands in both human and --json modes.
# Requires a valid API key in config.json (run `yoso-agent setup` first).
#
...
# =============================================================================
echo ""
echo "YOSO Agent CLI Test Suite"
echo "=================================================="
...
skip_test "sell create" "would register on marketplace"
skip_test "sell delete" "would delist from marketplace"
